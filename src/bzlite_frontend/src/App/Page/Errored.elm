module App.Page.Errored exposing (PageLoadError, pageLoadError, view)
...
type alias Model =
    { activePage : App.Views.Page.ActivePage
    , errorMessage : String
    }


pageLoadError : App.Views.Page.ActivePage -> String -> PageLoadError
...
view : App.Data.Session.Model -> PageLoadError -> Html msg
